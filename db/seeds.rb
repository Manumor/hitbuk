...
University.create(name: "Oxford University", city: "Oxford", country_id: 1,image: "http://web.prm.ox.ac.uk/rpr/images/oxunilogo.png", link: "link")
...
University.create(name: "Cambridge University", city: "Cambridge", country_id: 1,image: "https://www.cam.ac.uk/sites/www.cam.ac.uk/files/inner-images/logo.jpg", link: "link")
...
University.create(name: "Essex University", city: "Essex", country_id: 1,image: "http://opticalm.ca/images/Essex%20logo.jpg", link: "link")
...
University.create(name: "Warwick University", city: "Essex", country_id: 1,image: "https://upload.wikimedia.org/wikipedia/en/thumb/3/3e/University_of_Warwick_logo_2015_with_descriptor.svg/1280px-University_of_Warwick_logo_2015_with_descriptor.svg.png", link: "link")
...
University.create(name: "Harvard University", city: "Boston", country_id: 2,image: "https://s-media-cache-ak0.pinimg.com/236x/24/c9/86/24c9867e0e579d9b95d927554366afe6.jpg", link: "link")
...
University.create(name: "Stamford University", city: "Palo Alto", country_id: 2,image: "https://music.unt.edu/graduate/sites/default/files/Stanford-University-logo.jpg", link: "link")
...
University.create(name: "Columbia University", city: "New York", country_id: 2,image: "http://www.usjournal.com/img/columbia390x111logo.gif", link: "link")
...
University.create(name: "Boston University", city: "Boston", country_id: 2,image: "http://msfhq.com/wp-content/uploads/2010/12/Boston-University-Logo.jpg", link: "link")
